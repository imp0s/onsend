(function (global) {
  const configuredDomainExtensions = Array.isArray(
  ...
  function getAllowedDomains() {
    const senderDomain = extractDomain(
      global.Office?.context?.mailbox?.userProfile?.emailAddress,
    );

    const configured = Array.isArray(configuredDomainExtensions)
      ? configuredDomainExtensions
      : [];
    const domains = [
      senderDomain,
  ...
  function registerHandlers() {
    ...
    if (typeof global !== "undefined") {
      global.onMessageSend = onMessageSend;
    }
  }
  ...
  global.EmailSafetyChecker = EmailSafetyChecker;
  if (typeof module !== "undefined" && module.exports) {
    module.exports = EmailSafetyChecker;
  }
